...
class AnimalController extends Controller {
    ...
    $sql = "INSERT INTO animal (name, breed_id, img_path, diet, habitat) VALUES (:name, :breed_id, :img_path, :diet, :habitat)";
    // Préparation de la requête SQL (Mise en mémoire pour la manipuler via PDOStatement)
    $stmt = $pdo->prepare($sql);
    // Vérification de la présence des données
    if (isset($_POST['animalNameAdd']) && isset($_POST['breedAnimal']) && isset($_FILES['imgAnimalAdd']) && isset($_POST['dietAnimal']) && isset($_POST['habitatAnimal'])) {
